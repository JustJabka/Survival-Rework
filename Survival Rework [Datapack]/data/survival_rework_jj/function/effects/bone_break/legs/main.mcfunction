...
execute if score @s[tag=survival_rework_jj.have_splint] survival_rework_jj.legs_break.heal_timer matches ..0 if score @s survival_rework_jj.effect.legs_break matches 1.. run function survival_rework_jj:effects/bone_break/legs/clear