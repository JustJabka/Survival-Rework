execute if items entity @s armor.* *[minecraft:enchantments~[{enchantments:["survival_rework_jj:frostguard"]}]] run return run function survival_rework_jj:enchantment/frostguard
