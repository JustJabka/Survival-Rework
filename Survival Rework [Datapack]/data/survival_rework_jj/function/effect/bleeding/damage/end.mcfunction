...
execute if score @s[tag=survival_rework_jj.effect.bleeding.1] survival_rework_jj.effect.bleeding matches 0 run function survival_rework_jj:effect/bleeding/clear