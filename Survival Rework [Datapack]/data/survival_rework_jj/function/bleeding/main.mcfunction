...
scoreboard players remove @s[scores={survival_rework_jj.bleeding_timer=1..}] survival_rework_jj.bleeding_timer 1
execute if score @s survival_rework_jj.bleeding_timer matches ..1 run function survival_rework_jj:bleeding/timer
