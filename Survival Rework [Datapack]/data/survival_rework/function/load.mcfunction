...
execute unless score .temperature survival_rework.config matches 0..1 run data modify storage survival_rework:main actionbar.temperature set value ["","","","",""]
