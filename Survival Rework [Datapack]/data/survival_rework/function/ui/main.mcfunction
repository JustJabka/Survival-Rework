...
execute if predicate justlib:shared/has_vehicle if function survival_rework:ui/health_overlap run return run function survival_rework:ui/in_water with storage survival_rework:main ui
