...
# cos(x) / 24000
execute store result score $in jabkacore.math run scoreboard players operation #daytime main /= #24000 const
execute store result score #daytime main run function jabkacore:api/math/cos/calc
